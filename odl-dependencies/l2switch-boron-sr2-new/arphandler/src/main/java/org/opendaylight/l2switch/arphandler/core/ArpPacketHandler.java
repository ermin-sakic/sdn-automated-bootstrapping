...
public class ArpPacketHandler implements ArpPacketListener {
    ...
    public void onArpPacketReceived(ArpPacketReceived packetReceived) {
        if (packetReceived == null || packetReceived.getPacketChain() == null) {
            //LOG.info("DEMO: A packet received but the packet chain equals null");
            return;
        }

        //LOG.info("DEMO: An ARP packet received");
        ...
        //LOG.info("DEMO: Dispatching an ARP packet");
        /*
            Commented this out because I do not want ARP packets to be flooded since it causes
            wrong discovery of controller links
         */
