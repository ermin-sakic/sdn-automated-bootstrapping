...
sudo ./clean_previous_sessions.sh
sudo ./push_log_conf.sh
...
sudo ip netns exec ODL-Controller-SDNC-1 ./distribution/opendaylight-karaf/target/assembly/bin/karaf debug
#sudo ./clean_up.sh
