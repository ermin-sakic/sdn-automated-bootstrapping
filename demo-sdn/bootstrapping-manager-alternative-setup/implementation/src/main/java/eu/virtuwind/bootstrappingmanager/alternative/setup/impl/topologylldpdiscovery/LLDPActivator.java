...
public class LLDPActivator implements AutoCloseable {
    private static final Logger LOG = LoggerFactory.getLogger(org.opendaylight.openflowplugin.applications.topology.lldp.LLDPActivator.class);

    private static String lldpSecureKey = "blabla";
