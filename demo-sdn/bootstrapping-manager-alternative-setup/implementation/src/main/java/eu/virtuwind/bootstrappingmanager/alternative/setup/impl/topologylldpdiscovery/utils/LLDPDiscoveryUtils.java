 ...
 */
package eu.virtuwind.bootstrappingmanager.alternative.setup.impl.topologylldpdiscovery.utils;
...
public class LLDPDiscoveryUtils {
    private static final Logger LOG = LoggerFactory.getLogger(org.opendaylight.openflowplugin.applications.topology.lldp.utils.LLDPDiscoveryUtils.class);
     ...
     * @see org.opendaylight.openflowplugin.applications.topology.lldp.utils.LLDPDiscoveryUtils#lldpToNodeConnectorRef(byte[], boolean)
     */
