...
$SW_CONN_UTIL sw_$BOTTOM_ROOT_INDEX sw_$(( $BOTTOM_ROOT_INDEX - 1 )) veth$(( $BOTTOM_ROOT_INDEX - 1))-$BOTTOM_ROOT_INDEX-a veth$(( $BOTTOM_ROOT_INDEX - 1))-$BOTTOM_ROOT_INDEX-b
echo "TOPOLOGY:Connecting vertical line bottom root: sw_$BOTTOM_ROOT_INDEX sw_$(( $BOTTOM_ROOT_INDEX - 1 )) veth$(( $BOTTOM_ROOT_INDEX - 1))-$BOTTOM_ROOT_INDEX-a veth$(( $BOTTOM_ROOT_INDEX - 1))-$BOTTOM_ROOT_INDEX-b"
$SW_CONN_UTIL sw_$BOTTOM_ROOT_INDEX sw_$(( $NEXT_SWITCH_INDEX )) veth$NEXT_SWITCH_INDEX-$BOTTOM_ROOT_INDEX-a veth$NEXT_SWITCH_INDEX-$BOTTOM_ROOT_INDEX-b
echo "TOPOLOGY:Connecting vertical line bottom root: sw_$BOTTOM_ROOT_INDEX sw_$(( $NEXT_SWITCH_INDEX )) veth$NEXT_SWITCH_INDEX-$BOTTOM_ROOT_INDEX-a veth$NEXT_SWITCH_INDEX-$BOTTOM_ROOT_INDEX-b"
