...
$SW_CONN_UTIL sw_$BOTTOM_ROOT_INDEX sw_$(( $BOTTOM_ROOT_INDEX - 1 )) veth$BOTTOM_ROOT_INDEX-$(( $BOTTOM_ROOT_INDEX - 1))-a veth$BOTTOM_ROOT_INDEX-$(( $BOTTOM_ROOT_INDEX - 1))-b
echo "TOPOLOGY:Connecting vertical line bottom root: sw_$BOTTOM_ROOT_INDEX sw_$(( $BOTTOM_ROOT_INDEX - 1 )) veth$BOTTOM_ROOT_INDEX-$(( $BOTTOM_ROOT_INDEX - 1))-a veth$BOTTOM_ROOT_INDEX-$(( $BOTTOM_ROOT_INDEX - 1))-b"
$SW_CONN_UTIL sw_$BOTTOM_ROOT_INDEX sw_$(( $NEXT_SWITCH_INDEX )) veth$BOTTOM_ROOT_INDEX-$NEXT_SWITCH_INDEX-a veth$BOTTOM_ROOT_INDEX-$NEXT_SWITCH_INDEX-b
echo "TOPOLOGY:Connecting vertical line bottom root: sw_$BOTTOM_ROOT_INDEX sw_$(( $NEXT_SWITCH_INDEX )) veth$BOTTOM_ROOT_INDEX-$NEXT_SWITCH_INDEX-a veth$BOTTOM_ROOT_INDEX-$NEXT_SWITCH_INDEX-b"
